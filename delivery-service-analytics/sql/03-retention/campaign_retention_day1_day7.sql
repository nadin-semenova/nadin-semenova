-- Calculates Day 0, Day 1, and Day 7 retention for users acquired via
-- Campaign 1 vs Campaign 2.
-- Result: Campaign 1 Day 1 = 42%, Day 7 = 22%
--         Campaign 2 Day 1 = 17%, Day 7 = 9%
-- Directly explains the ROI gap: social media users drop off more than
-- twice as fast, generating far less lifetime revenue.
