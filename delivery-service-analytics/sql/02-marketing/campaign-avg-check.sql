-- Compares average order value for users acquired via each ad campaign
-- during their first week in the app (Sep 1–7, 2022).
-- Calculated as a two-level average: first per user, then per campaign,
-- to avoid larger users distorting the mean.
-- Note: Campaign 2 has a slightly higher avg check (380.88 vs 371.73)
-- yet still produces negative ROI — users from Campaign 2 order less frequently.
