-- Calculates Customer Acquisition Cost (CAC) for two ad campaigns.
-- CAC = campaign budget / number of paying users acquired.
-- A paying user is one who placed at least one non-cancelled order.
-- Result: Campaign 1 CAC = 1,461.99, Campaign 2 CAC = 1,068.38.
-- Note: lower CAC does not automatically mean better ROI — see next query.
