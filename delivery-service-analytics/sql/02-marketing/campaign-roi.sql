-- Calculates ROI (Return on Investment) for each ad campaign.
-- ROI = (total revenue from acquired users - campaign spend) / spend * 100%.
-- Campaign spend: 250,000 each.
-- Insight: Campaign 1 ROI = +14.5% (profitable),
--          Campaign 2 ROI = -1.61% (loss-making despite lower CAC).
