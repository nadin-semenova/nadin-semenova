-- Tracks cumulative ARPPU day by day for each campaign cohort,
-- plotted against the fixed CAC line.
-- The day when cumulative ARPPU crosses CAC is the payback day.
-- Insight: Campaign 1 reached payback on Day 5 (cumulative ARPPU 1,464 > CAC 1,462).
--          Campaign 2 did not reach payback within the 8-day observation window
--          (cumulative ARPPU 1,051 vs CAC 1,068 on Day 7).
